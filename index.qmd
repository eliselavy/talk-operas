...
|-------|------|------------|
| **Collect** | Transkribus *(general account)* | Handwritten text recogniser |
| **Collect** | Nodegoat *(own instance)* | Relational data modeller |
| **Collect** | Muse | Multimedia search engine | Home made
| **Archive** | Dataverse *(own instance)* | Research data repository |
| **Archive** | Nainuwa | Digital library system |
| **Publish** | Omeka | Digital collections publisher |
...
| **Infrastructure** | GitHub *(own instance)* | Code version control |
| **Infrastructure** | HuggingFace | Model & dataset hub |
| **Infrastructure** | OpenAI | AI API provider |
| **Infrastructure** | AWS | Cloud computing platform |
...
| **Infrastructure** | GitHub *(own instance)* | Code version control | Research software dev · Data governance |
